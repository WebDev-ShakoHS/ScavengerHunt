...
<body>
	...
	<div class="content">
		...
		<?php  if (isset($_SESSION['username'])) : ?>
			...
			<center><p> <a href="index.php?logout='1'" style="color: black;"><button class ="btn2">Logout</button></a> </p></center>
			<center><a href="user.php"><button class="btn" style="margin:30px;">Continue To Site</button></a></center>
		<?php endif ?>
	</div>
</body>
